...
<body>
  ...
  <div>
    <c:forEach items="${noticeList}" var="n">
      <div class="notices" data-notice-id="${n.noticeId}">  <!-- data-notice-id 카멜케이스로 바뀜 -->
        공지번호 ${n.noticeId} | ${n.noticeTitle} 첨부파일 갯수 ${n.attachCount} ... <fmt:formatDate value="${n.createdAt}" pattern="yyyy.MM.dd HH:mm:ss"/>
      </div>
    </c:forEach>
  </div>
