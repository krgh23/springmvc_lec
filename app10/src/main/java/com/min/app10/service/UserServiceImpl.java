...
public class UserServiceImpl implements IUserService {
  ...
  public Map<String, Object> getUserList(HttpServletRequest request) {
    ...
    // 페이지 이동 링크 가져오기
    String paging = pageUtil.getPaging(request.getContextPath() + "/user/list.do", sort);  // 페이지 이동링크를 주소전달  ${contextPath}
    ...
    // page = 1 번호 = 1  (page - 1) * display  -> "offset", pageUtil.getOffset()
    // page = 2 번호 = 21
