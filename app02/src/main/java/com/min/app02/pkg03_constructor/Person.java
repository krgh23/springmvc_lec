...
/*
 * DI 방식 3 - Constructor 주입 (스프링에서 추천하는 가장 안전한 방식)
 * Spring Container 에 있는 bean 을 Constructor의 매개변수에 주입(전달)하는 방식입니다.
 * Constructor에 @Autowired 를 한 번만 추가하면 됩니다.
 ...
 * 필드에 final 키워드를 추가한뒤 @RequiredArgsConstructor 를 사용합니다.
 */
