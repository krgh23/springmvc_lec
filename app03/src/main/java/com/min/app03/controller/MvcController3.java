...
public class MvcController3 {
   ...
   * 각 파라미터 마다 @RequestParam Annotation 을 추가하여 Parameter 를 직접 변수로 받을 수 있습니다.
   * Parameter 의 필수 여부와 디폴트 값 설정을 할 수 있습니다.
   * @RequestParam Annotation은 생략도 할 수 있습니다. 생략하면 선언된 변수로 추론하여 값을 받습니다.(추론은 100% 완벽히 되지는 않는다.)
   */
