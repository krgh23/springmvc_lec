...
public class PageUtil {
  ...
  public void setPaging(int page, int display, int total) {
    ...
    int pagePerBlock = 10;    
    totalPage = (int)Math.ceil((double)total / display); // 리스트에서 ceil 올림처리 1005인대 20개씩 보이면 5개가 안보임으로
  ...
  public String getPaging(String requestURI, String sort) {
    ...
    // <button type="button" onclick="location.href='/app10/user/list.do?page1'">2</button>
    // <button type="button" onclick="location.href='/app10/user/list.do?page1'">3</button>
