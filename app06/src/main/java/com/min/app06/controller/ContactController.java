...
public class ContactController {
  ...
  public String ditail(HttpServletRequest request, Model model) {
    // 요청 파라미터를 받습니다. Integer.perseInt() 하고 있으므로 요청 파라미터의 null 체크가 필요합니다.
  ...
  public String modify(HttpServletRequest request, RedirectAttributes redirectAttributes) {
    ...
    // 수정 성공/실패 메시지를 RedirectAttributes에 저장합니다. Model에 저장하면 리다이렉트 할때 전달되지 않습니다.
