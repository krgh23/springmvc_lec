...
public class MvcController1 {
  ...
  /*
   * Model
   * Forward 할 데이터를 저장할때 사용
   */
  
  @RequestMapping(value="/forward/main.do")   // url 맵핑 
  public String main() {
    return "webdir1/main"; // ViewResolver에 의해서 "/WEB-INF/webdir1/main.jsp" 파일경로로 이동합니다. (forward 합니다.)
  }
  ...
  public String foward(
    ...
    // HttpServletRequest request 에 전달한 데이터 속성(Attribute)의 형식으로 저장할 수 있습니다.
    request.setAttribute("email", "user@naver.com");
    
    // Model 에 전달할 데이터를 속성(Attribute)의 형식으로 저장할 수 있습니다. Spring은 Model 사용을 권장합니다.
    model.addAttribute("address", "서울특별시 강남구 강남대로");
    
    // Map 을 전달합니다.
    model.addAttribute("contact", Map.of("tel", "02-123-1234", "mobile", "010-9874-9874"));
    ...
    // list<String>를 전달합니다.
    model.addAttribute("hobbies", Arrays.asList("게임", "운동", "청소"));
