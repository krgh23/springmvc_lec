...
@Service  // 서비스에서 사용하는 @Componet입니다. Spring Container에 IBoardService 타입의 bean이 생성됩니다.
public class BoardServiceImpl implements IBoardService {
  ...
  public String removeBoardlist(String[] numbers) {
    // 삭제한 뒤 삭제 결과를 텍스트로 반환합니다.
    return boardDao.deleteSelectedBoard(numbers) == numbers.length ? "삭제 성공" : "삭제 실패";
  }
